<nav class="bg-gray-800">
  ...
  <el-disclosure id="mobile-menu" hidden class="md:hidden [&:not([hidden])]:block">
    <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
      ...
      <a href="/notes" <?= urlIs('/notes') ? 'aria-current="page" class="block rounded-md bg-gray-950/50 px-3 py-2 text-base font-medium text-white"' : 'class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white"' ?>>Notes</a>
